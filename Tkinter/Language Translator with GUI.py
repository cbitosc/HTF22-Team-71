...
Label(Screen, text="Language Translator", font=Titlefont, borderwidth=10).place(x=100, y=20)
InputLanguageChoiceMenu = OptionMenu(Screen, InputLanguageChoice, *inputlang)
InputLanguageChoiceMenu.config(font=Buttonfont)
Label(Screen, text="Choose a Language", font=Buttonfont).place(x=20, y=90)
...
Label(Screen, text="Translated Language", font=Buttonfont).place(x=750, y=90)
